...
```sh
grep -rl 'ytest' ./ | xargs sed -i '' 's/ytest/{YOUR INTEGRATION NAME}/g'
```
...
## Vue Storefront 2 integration with ytest
...
Want to contribute? Ping us on `ytest` channel on [our Discord](https://discord.vuestorefront.io)!
...
2. Clone your fork of the repo
    ```
    example:
    git clone https://github.com/vuestorefront/ytest.git
    cd ytest
    ```
...
- [ytest integration Documentation](https://docs.vuestorefront.io/ytest)
- [Community Chat](https://discord.vuestorefront.io)

## Support

If you have any questions about this integration we will be happy to answer them on `ytest` channel on [our Discord](discord.vuestorefront.io).
